...
double Test_ReLU_LS(int iter_time, double a,double b,double w0_0,double w0_1,double b0,double w1,double b1,double hide)
{
    int bit = 36;
...
void test_relu_LS()
{
    ...
    double act_res;
    double ab_res;
    double error_fhe=0.0;
    double error_cnn=0.0;
    ...
    for(int i=0;i<10;i++)
    {
        ...
        startTime = clock();
        relu_res=Test_ReLU_LS(iter_time, a,b,w0_0,w0_1,b0,w1,b1,hide);
        endTime = clock();
        cout << "fhe run time is: " <<(double)(endTime - startTime) / CLOCKS_PER_SEC << "s" << endl;
        ...
        endTime = clock();
        cout << "cnn run time is: " <<(double)(endTime - startTime) / CLOCKS_PER_SEC << "s" << endl;
    
        ab_res=a+b;
        cout<<"a+b: "<<ab_res<<endl;
        error_fhe+=abs(relu_res-ab_res)/ab_res;
        error_cnn+=abs(act_res-ab_res)/ab_res;
    }

    
    cout << "fhe error: " << error_fhe <<endl;
    cout << "fhe error: " << error_cnn <<endl;
