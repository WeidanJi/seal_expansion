...
uint64_t test_floatsub1(uint64_t a,uint64_t b)
{
    ...
    startTime=clock();
    evaluator.sub(cipher_a,cipher_b,cipher_sum1);
    endTime = clock();
    cout << "sub one time is: " <<(double)(endTime - startTime) / CLOCKS_PER_SEC << "s" << endl;
