...
uint64_t test_floatadd1(uint64_t a,uint64_t b)
{
    ...
    startTime=clock();
    evaluator.add(cipher_a,cipher_b,cipher_sum1);
    endTime = clock();
    cout << "add one time is: " <<(double)(endTime - startTime) / CLOCKS_PER_SEC << "s" << endl;
