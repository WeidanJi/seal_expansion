...
double Test_ReLU_taylor(int iter_time, double a,double b,double w0_0,double w0_1,double b0,double w1,double b1,double hide)
{
    int bit = 36;
...
void test_relu_taylor()
{
    ...
    for(int i=0;i<10;i++)
    {
        ...
        relu_res=Test_ReLU_taylor(iter_time, a,b,w0_0,w0_1,b0,w1,b1,hide);
